...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'en': {
      ...
      'vocabDays': "Days",
      'vocabTopics': "topics",
      'vocabTopicsDone': "topics done",
      'vocabNoWordsFound': "No words found for this topic.",
      'vocabTapToSpeak': "Tap to speak",
      'vocabListening': "Listening",
      'vocabSpeak': "Speak",
      'vocabSlow': "Slow",
      'vocabDefinition': "Definition",
      'vocabExamples': "Examples",
      'vocabNotQuiteRight': "Not quite right!",
      'vocabYouSaid': "You said:",
      'vocabGiveItAnotherTry': "Give it another try!",
      'vocabNextWord': "Next word",
      'vocabSeeResults': "See Results",
      'vocabExcellent': "Excellent!",
      'vocabGoodJob': "Good job!",
      'vocabPronunciationScore': "Pronunciation score",
      'vocabLessonComplete': "Lesson Complete!",
      'vocabWordsCompleted': "words completed",
      'vocabTryAgain': "Try Again",
      'vocabExitLesson': "Exit Lesson",
      'vocabPerfect': "Perfect",
      'vocabIncorrect': "Incorrect",
      'vocabSkip': "Skip",
      'vocabSkipped': "Skipped",
    ...
    'ja': {
      ...
      'vocabDays': "日程",
      'vocabTopics': "トピック",
      'vocabTopicsDone': "トピック完了",
      'vocabNoWordsFound': "このトピックの単語が見つかりません。",
      'vocabTapToSpeak': "タップして話す",
      'vocabListening': "聞き取り中",
      'vocabSpeak': "読み上げ",
      'vocabSlow': "ゆっくり",
      'vocabDefinition': "定義",
      'vocabExamples': "例文",
      'vocabNotQuiteRight': "惜しい！",
      'vocabYouSaid': "あなたの発音：",
      'vocabGiveItAnotherTry': "もう一度試してみましょう！",
      'vocabNextWord': "次の単語",
      'vocabSeeResults': "結果を見る",
      'vocabExcellent': "素晴らしい！",
      'vocabGoodJob': "よくできました！",
      'vocabPronunciationScore': "発音スコア",
      'vocabLessonComplete': "レッスン完了！",
      'vocabWordsCompleted': "単語完了",
      'vocabTryAgain': "もう一度",
      'vocabExitLesson': "レッスンを終了",
      'vocabPerfect': "完璧",
      'vocabIncorrect': "不正確",
      'vocabSkip': "スキップ",
      'vocabSkipped': "スキップ済み",
    ...
    'hi': {
      ...
      'vocabDays': "दिन",
      'vocabTopics': "विषय",
      'vocabTopicsDone': "विषय पूरे",
      'vocabNoWordsFound': "इस विषय के लिए कोई शब्द नहीं मिला।",
      'vocabTapToSpeak': "बोलने के लिए टैप करें",
      'vocabListening': "सुन रहे हैं",
      'vocabSpeak': "बोलें",
      'vocabSlow': "धीमा",
      'vocabDefinition': "परिभाषा",
      'vocabExamples': "उदाहरण",
      'vocabNotQuiteRight': "बिल्कुल सही नहीं!",
      'vocabYouSaid': "आपने कहा:",
      'vocabGiveItAnotherTry': "एक और प्रयास करें!",
      'vocabNextWord': "अगला शब्द",
      'vocabSeeResults': "परिणाम देखें",
      'vocabExcellent': "उत्कृष्ट!",
      'vocabGoodJob': "शाबाश!",
      'vocabPronunciationScore': "उच्चारण स्कोर",
      'vocabLessonComplete': "पाठ पूरा!",
      'vocabWordsCompleted': "शब्द पूरे",
      'vocabTryAgain': "फिर से करें",
      'vocabExitLesson': "पाठ छोड़ें",
      'vocabPerfect': "परफेक्ट",
      'vocabIncorrect': "गलत",
      'vocabSkip': "छोड़ें",
      'vocabSkipped': "छोड़ा",
    ...
    'es': {
      ...
      'vocabDays': "Días",
      'vocabTopics': "temas",
      'vocabTopicsDone': "temas completados",
      'vocabNoWordsFound': "No se encontraron palabras para este tema.",
      'vocabTapToSpeak': "Toca para hablar",
      'vocabListening': "Escuchando",
      'vocabSpeak': "Escuchar",
      'vocabSlow': "Lento",
      'vocabDefinition': "Definición",
      'vocabExamples': "Ejemplos",
      'vocabNotQuiteRight': "¡No del todo bien!",
      'vocabYouSaid': "Dijiste:",
      'vocabGiveItAnotherTry': "¡Inténtalo de nuevo!",
      'vocabNextWord': "Siguiente palabra",
      'vocabSeeResults': "Ver resultados",
      'vocabExcellent': "¡Excelente!",
      'vocabGoodJob': "¡Buen trabajo!",
      'vocabPronunciationScore': "Puntuación de pronunciación",
      'vocabLessonComplete': "¡Lección completa!",
      'vocabWordsCompleted': "palabras completadas",
      'vocabTryAgain': "Intentar de nuevo",
      'vocabExitLesson': "Salir de la lección",
      'vocabPerfect': "Perfecto",
      'vocabIncorrect': "Incorrecto",
      'vocabSkip': "Omitir",
      'vocabSkipped': "Omitido",
