...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha, your English partner. Let’s start with introductions — can you tell me a bit about yourself?',
),
ScenarioModel(
  ...
  intro: 'Hello! Let’s talk about your day. What’s the first thing you do in the morning?',
),
ScenarioModel(
  title: 'Weekend Plans',
...
ScenarioModel(
  ...
  intro: 'Hello! Let’s talk about home chores. Do you like cooking or cleaning?',
),
ScenarioModel(
  ...
  intro: 'Hi there! I’m Natasha at the station — where are you travelling today?',
),
ScenarioModel(
  title: 'Managing Time',
  ...
  intro: 'Hey! I’m Natasha. Let’s talk about how you manage your time. Do you plan your day?',
),
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha, your health buddy. How do you take care of yourself every day?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Tell me about your family — who do you live with?',
),
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. Can you describe your best friend or a family member?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. Let’s talk about your childhood — what games did you love?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. Let’s learn to handle disagreements politely — shall we talk it out?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Let’s discuss relationships — what makes them strong and positive?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha, your waiter for today. What would you like to order?',
),
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha. Tell me — what’s your favorite dish and why do you love it?',
),
ScenarioModel(
  ...
  intro: 'Hi traveler! I’m Natasha at the airport. Where are you flying today?',
),
ScenarioModel(
  ...
  intro: 'Welcome! I’m Natasha at the front desk. What kind of room would you like to book?',
),
ScenarioModel(
  ...
  intro: 'Namaste! I’m Natasha. What festival do you love celebrating the most?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha, your local guide. Want to learn about our customs?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha, your classmate. How’s your school or college life?',
),
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha. Which subject do you enjoy learning the most?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. Exams are coming — how do you prepare for them?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Everyone makes mistakes — what have yours taught you?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi, I’m Natasha, your interviewer. Let’s start — can you tell me about yourself?',
),
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha, your teammate. Can we talk about our current project?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Let’s practice how to give and receive feedback politely.',
),
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha calling from the client side. Can you give me an update?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha from the store. What would you like to buy today?',
),
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha. Are you looking for something affordable or premium?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha from customer support. Did you enjoy your recent purchase?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha, your financial guide. Do you usually save money each month?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Let’s practice sharing opinions. What’s your view on social media?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Everyone feels stressed sometimes—what helps you calm down?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. Let’s practice agreeing and disagreeing politely.',
),
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha. Can you share a memorable moment from your life?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. Let’s practice saying sorry and forgiving someone.',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. Do you think social media has more pros or cons?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. How many hours do you spend on your phone daily?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. What do you do when you want a break from screens?',
),
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. What can we do to fight climate change together?',
),
ScenarioModel(
  ...
  intro: 'Hello! I’m Natasha. Have you ever volunteered for a community cause?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Do you think animals should have more protection?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. Can you tell me a short story from your imagination?',
),
ScenarioModel(
  ...
  intro: 'Hey! I’m Natasha. What would you do if you could fly for one day?',
),
ScenarioModel(
...
ScenarioModel(
  ...
  intro: 'Hi! I’m Natasha. What do you think life will be like in the future?',
),
ScenarioModel(
